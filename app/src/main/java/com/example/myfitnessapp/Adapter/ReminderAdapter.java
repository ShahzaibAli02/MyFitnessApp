...
import com.example.myfitnessapp.Activities.ShowReminder;
...
public class ReminderAdapter extends RecyclerView.Adapter<ReminderAdapter.ViewHolder> {
    ...
    private List<ModelReminder> mData;
    private LayoutInflater mInflater;
    private  Context mContext;


    public ReminderAdapter(Context context, List<ModelReminder> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_reminder, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position)
    {
        ...
        final ModelReminder obj = mData.get(position);
        holder.txtTitle.setText(obj.getTitle());
        holder.txtTime.setText(obj.getDate());
    ...
    private void AskForDelet(final ModelReminder obj, final int position)
    {
               ...
               new Thread()
               {
                   ...
                   public void run()
                   {
                       ...
                       ((Activity) mContext).runOnUiThread(new Runnable() {
                           @Override
                           public void run() {
                               cancelAlarm(obj.getRequestcode());
    ...
    private void cancelAlarm(int RequestCode){
        ...
        Intent intent = new Intent(mContext, ShowReminder.class);
